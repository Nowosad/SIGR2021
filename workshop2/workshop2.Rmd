...
https://github.com/geocompr/geocompr.github.io/blob/source/content/post/2021/spatial-classes.Rmd
...
# local 
srtm_utm_cor = autocor(srtm_utm, w = f, global = FALSE)
srtm_utm_cor
```
]
...
```{r, message=FALSE}
library(fields)
tps = Tps(st_coordinates(zion_points_utm), zion_points_utm$srtm)
rt = rast(srtm_utm)
